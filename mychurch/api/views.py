...
def update_user_profile(request):
    """
    Update user profile including full_name, bio, location
    ...
    try:
        ...
        if 'full_name' in request.data:
            user_updates['full_name'] = request.data['full_name']
        ...
        # Update Profile model fields (bio, location)
        profile_data = {}
        ...
        if profile_data:
            profile_serializer = MyProfileSerializer(profile, data=profile_data, partial=True)
    ...
    def get(self, request):
        ...
        for user in users:
            data.append({
                ...
                'profile_picture': user.profile.profile_picture if hasattr(user, 'profile') and user.profile else None,
